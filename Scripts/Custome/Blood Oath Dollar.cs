...
namespace Server.Items
{
    public class AkaraDolla : Item
    {
        ...
        [Constructable]
        public AkaraDolla(int amountFrom, int amountTo)
            : this(Utility.RandomMinMax(amountFrom, amountTo))
        {
        }

        [Constructable]
        public AkaraDolla(int amount)
            : base(0xEF3)
        {
            this.Stackable = true;
            this.Amount = amount;
			this.Hue = 2744;
			this.Name = "Akara Dolla";
        }

        public AkaraDolla(Serial serial)
            : base(serial)
        {
        }
